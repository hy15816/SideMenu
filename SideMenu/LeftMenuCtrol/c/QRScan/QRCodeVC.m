...
- (void)viewDidLoad {
    ...
    UIImage *qrcode = [self createNonInterpolatedUIImageFormCIImage:[self createQRForString:@"http://www.cnblogs.com/hyim"] withSize:(kDEVICE_WIDTH - 50)/2.f];
    UIImage *customQR = [self imageBlackToTransparent:qrcode withRed:60.f andGreen:74.f andBlue:89.f];//二维码图片将要显示的颜色
    self.qrImage.image = customQR;
    //添加阴影
