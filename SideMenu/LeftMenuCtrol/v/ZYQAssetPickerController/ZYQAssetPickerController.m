...
-(void)drawRect:(CGRect)rect{
    ...
    //[self.text drawInRect:CGRectMake(0, 0, rect.size.width - titleSize.width - 2 , (height - 12) / 2) withAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:12]}];//,NSForegroundColorAttributeName:nil,
...
- (id)init
{
    ...
    {
        _maximumNumberOfSelection      = MAX_CANON;
