...
- (void)dd_setNumber:(NSNumber *)number{
    [self dd_setNumber:number duration:kDuration format:nil attributes:nil];
}

- (void)dd_setNumber:(NSNumber *)number formatter:(NSNumberFormatter *)formatter{
    if(!formatter)
        formatter = [self defaultFormatter];
    [self dd_setNumber:number duration:kDuration format:nil numberFormatter:formatter attributes:nil];
}

- (void)dd_setNumber:(NSNumber *)number format:(NSString *)formatStr{
    [self dd_setNumber:number duration:kDuration format:formatStr attributes:nil];
}

- (void)dd_setNumber:(NSNumber *)number format:(NSString *)formatStr formatter:(NSNumberFormatter *)formatter{
    if(!formatter)
        formatter = [self defaultFormatter];
    [self dd_setNumber:number duration:kDuration format:formatStr numberFormatter:formatter attributes:nil];
}

- (void)dd_setNumber:(NSNumber *)number attributes:(id)attrs{
    [self dd_setNumber:number duration:kDuration format:nil attributes:attrs];
}
...
- (void)dd_setNumber:(NSNumber *)number formatter:(NSNumberFormatter *)formatter attributes:(id)attrs{
    if(!formatter)
        formatter = [self defaultFormatter];
    [self dd_setNumber:number duration:kDuration format:nil numberFormatter:formatter attributes:attrs];
}
